...
import { HotTopicComment } from './HotTopicComment';

/*
thoughts: I think i should make this a list of hot topics and then each hot topic will have a title and then a list of comments.
maybe:
hot topic -> topicList -> comment list 
*/
export default class HotTopicCommentList extends React.Component {
